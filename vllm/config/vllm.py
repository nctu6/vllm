...
class VllmConfig:
    ...
    def __post_init__(self):
        ...
        if (
            ...
            logger.info_once(
                "Using ngram_gpu for ngram with unieai_dsc and async scheduling.",
                scope="local",
            )
